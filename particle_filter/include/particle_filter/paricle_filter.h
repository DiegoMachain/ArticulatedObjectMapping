...
public:
  ...
  template <class ZType, class AType> double calculateKLdivergence (std::vector<Particle <ArticulationModelPtr> >& particles, const double z_exp, const AType a, const Eigen::MatrixXd& noiseCov,
                                                                              const SensorActionModel<ArticulationModelPtr, ZType, AType>& model);
