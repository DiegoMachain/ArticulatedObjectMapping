...
struct MotionPlanRequest_
{
  ...
  _max_acceleration_scaling_factor_type max_acceleration_scaling_factor;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _cartesian_speed_limited_link_type;
...
struct MD5Sum< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x83f3d7b1d47a538fULL;
  static const uint64_t static_value2 = 0x7659e0de9dae7980ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.cartesian_speed_limited_link);
...
struct Printer< ::moveit_msgs::MotionPlanRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::MotionPlanRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "cartesian_speed_limited_link: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.cartesian_speed_limited_link);
