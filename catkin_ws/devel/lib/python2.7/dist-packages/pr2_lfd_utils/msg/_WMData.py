...
"""autogenerated by genpy from pr2_lfd_utils/WMData.msg. Do not edit."""
import codecs
import sys
...
class WMData(genpy.Message):
  _md5sum = "68dcda98ef9b16735859eaf0e9474409"
  _type = "pr2_lfd_utils/WMData"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pr2_lfd_utils/WMObject[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WMData, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_IB().pack(_x.id, _x.currently_visible))
        _v3 = val1.pose
        _v4 = _v3.header
        _x = _v4.seq
        buff.write(_get_struct_I().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pr2_lfd_utils.msg.WMObject()
        _v9 = val1.header
        start = end
        end += 4
        ...
        (_x.id, _x.currently_visible,) = _get_struct_IB().unpack(str[start:end])
        val1.currently_visible = bool(val1.currently_visible)
        _v11 = val1.pose
        _v12 = _v11.header
        start = end
        end += 4
