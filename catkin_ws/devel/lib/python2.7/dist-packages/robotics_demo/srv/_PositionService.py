...
"""autogenerated by genpy from robotics_demo/PositionServiceRequest.msg. Do not edit."""
import codecs
import sys
...
import robotics_demo.msg

class PositionServiceRequest(genpy.Message):
  _md5sum = "bd0742a57f699ed2087743384a0ea3dd"
  _type = "robotics_demo/PositionServiceRequest"
...
"""
  __slots__ = ['input']
  _slot_types = ['robotics_demo/PosRot']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.input is None:
        self.input = robotics_demo.msg.PosRot()
    else:
      self.input = robotics_demo.msg.PosRot()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.input.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.input.id = str[start:end]
      return self
...
def _get_struct_7f():
    ...
    return _struct_7f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robotics_demo/PositionServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PositionServiceResponse(genpy.Message):
  _md5sum = "3de20a0b2a7468dbd60e3a558bf7e00d"
  _type = "robotics_demo/PositionServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.output is None:
        self.output = robotics_demo.msg.PosRot()
    else:
      self.output = robotics_demo.msg.PosRot()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.output.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.output.id = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class PositionService(object):
  _type          = 'robotics_demo/PositionService'
  _md5sum = 'b2629d4cbee41789622cf2931b4df30e'
