...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PositionService-request>)))
  ...
  (cl:format cl:nil "PosRot input~%~%================================================================================~%MSG: unity_robotics_demo_msgs/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%string id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PositionService-request)))
  "Returns full string definition for message of type 'PositionService-request"
  (cl:format cl:nil "PosRot input~%~%================================================================================~%MSG: unity_robotics_demo_msgs/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%string id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PositionService-response>)))
  ...
  (cl:format cl:nil "PosRot output~%~%================================================================================~%MSG: unity_robotics_demo_msgs/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%string id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PositionService-response)))
  "Returns full string definition for message of type 'PositionService-response"
  (cl:format cl:nil "PosRot output~%~%================================================================================~%MSG: unity_robotics_demo_msgs/PosRot~%float32 pos_x~%float32 pos_y~%float32 pos_z~%float32 rot_x~%float32 rot_y~%float32 rot_z~%float32 rot_w~%string id~%~%~%"))
