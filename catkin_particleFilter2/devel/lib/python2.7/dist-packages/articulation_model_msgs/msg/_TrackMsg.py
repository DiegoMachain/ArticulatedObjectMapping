...
"""autogenerated by genpy from articulation_model_msgs/TrackMsg.msg. Do not edit."""
import codecs
import sys
...
class TrackMsg(genpy.Message):
  ...
  _type = "articulation_model_msgs/TrackMsg"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.pose_flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pose_flags = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.channels = []
